# Knowledge Base - Toserba WS Pedak
...
7. Pesanan akan dikirim langsung ke WhatsApp toko
8. Konfirmasi pesanan dan lakukan pembayaran

### Belanja Langsung di Toko
- Datang langsung ke alamat toko
- Pilih produk di rak
- Bayar di kasir (tunai/transfer)
...
A: Minimum pembelian untuk pengiriman adalah Rp 50.000.
...
**Q: Kapan harus bayar?**
A: Untuk pengiriman, pembayaran dilakukan setelah konfirmasi pesanan via WhatsApp. Untuk ambil di toko, bisa bayar saat pengambilan.

### Produk

**Q: Apakah produk dijamin original?**
A: Ya, 100% produk kami original dan dijamin kualitasnya.

**Q: Bagaimana jika produk yang diterima rusak?**
A: Hubungi kami segera via WhatsApp dengan foto produk. Kami akan ganti dengan produk baru atau refund.

**Q: Apakah harga di website sama dengan di toko?**
A: Ya, harga di website sama dengan harga di toko fisik kami.

---

## KEUNGGULAN TOSERBA WS PEDAK

1. **Harga Murah** - Harga bersaing dengan kualitas terjamin
2. **Produk Lengkap** - Berbagai macam kebutuhan tersedia di satu tempat
3. **Pelayanan Ramah** - Tim kami siap membantu kebutuhan Anda
4. **Gratis Ongkir** - Min. pembelian Rp 50.000
5. **Pengiriman Cepat** - Pengiriman cepat dan tepat waktu
6. **100% Original** - Semua produk asli dan berkualitas
...
- "Hai! Terima kasih sudah menghubungi Toserba WS Pedak. Apa yang bisa saya bantu hari ini?"

### Sapaan Penutup
- "Terima kasih sudah berbelanja di Toserba WS Pedak! Jika ada pertanyaan lain, jangan ragu untuk menghubungi kami."
- "Semoga informasinya membantu! Ditunggu pesanannya ya. Terima kasih!"

### Jika Tidak Bisa Menjawab
- "Mohon maaf, untuk pertanyaan ini saya perlu konfirmasi lebih lanjut. Boleh saya hubungkan dengan tim kami via WhatsApp di +62 812-3960-2221?"
...
Format dokumen ini sudah dioptimalkan untuk:
- RAG (Retrieval-Augmented Generation)
- Fine-tuning LLM
- Chatbot integration (Dialogflow, Rasa, dll)

---

*Dokumen ini terakhir diperbarui: 22 Desember 2024*
